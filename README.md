...
- - Если вы выбрали mysql вам предложат ответить на вопрос `Используете ли вы MariaDB 10.3 или выше?`, на которой вы должны ответить Y - если у вас MeriaDB 10.3 и ливыше или N в случае если у вас другая база данных.
